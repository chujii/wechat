...
/**
 * @Author: binghe
 * @Date:   2017-06-21 16:18:48
 * @Last Modified by:   binghe
 * @Last Modified time: 2017-06-21 16:19:28
 */
namespace Binghe\Wechat\Tests\Menu;
use Binghe\Wechat\Menu\Menu;
use Binghe\Wechat\Tests\TestCase;
class MenuMenuTest extends TestCase
{
    public function getMenu()
    {
        $menu = \Mockery::mock('Binghe\Wechat\Menu\Menu[parseJSON]', [\Mockery::mock('Binghe\Wechat\Core\AccessToken')]);
